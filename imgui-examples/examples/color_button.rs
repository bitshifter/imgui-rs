...
fn example_1(state: &mut State, ui: &Ui) {
    ui.window("Example 1: Basics")
        ...
        .build(|| {
            ...
            if ui
                .color_button("Black color", (0.0, 0.0, 0.0, 1.0))
                .build()
            {
            ...
            if ui
                .color_button("Red color", (1.0, 0.0, 0.0, 1.0))
                .build()
            {
            ...
            if ui
                .color_button("Green color", (0.0, 1.0, 0.0, 1.0))
                .size((100.0, 50.0))
                .build()
            {
            ...
            if ui
                .color_button("No tooltip", (0.0, 0.0, 1.0, 1.0))
                .tooltip(false)
                .build()
            {
